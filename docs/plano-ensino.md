...
## Ementa
1.  **Módulo 1: Fundamentos de DevOps**: Cultura DevOps, Metodologias Ágeis, Controle de Versão (Git) e Github.
2.  **Módulo 2: Integração Contínua e Automação**: Pipeline de CI/CD, Build Automatizado, Containers (Docker) e Virtualização.
3.  **Módulo 3: Cloud Computing**: Fundamentos de Nuvem, AWS, Azure, GCP, Deploy em Cloud e Infraestrutura como Código (Terraform).
4.  **Módulo 4: Operações e Segurança**: Monitoramento (Prometheus/Grafana), DevSecOps, Segurança em Pipelines e Mercado de Trabalho.
